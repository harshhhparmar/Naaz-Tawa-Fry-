...
export const WHY_CHOOSE_US = [
  {
    title: "Rich Mughlai Heritage",
    description: "Authentic recipes passed down through generations."
  },
  {
    title: "100% Fresh Ingredients",
    description: "We use only the finest spices and freshest cuts of meat daily."
  },
  {
    title: "Family Restaurant",
    description: "A comfortable, welcoming environment for families and groups."
  },
  {
